...
<tr>
<th> Show </th> <th>Model </th> <th> GalazyDock score </th><th>Energy, kcal/mol (FoldX) </th><th>Download PDB </th>
</tr>
  ...
  <script>
   ...
   peptide_reps = [];
    ...
    var arrayLength = names.length;
        ...
        document.write(`<tr><td> <input type="checkbox" id="${i}" name="${names[i]}"></td> <td>  ${models[i]}  </td> <td> ${galaxy_scores[i]} </td><td> ${energies[i]} </td></td><td> <a href="https://intbio.org/RNF_24-14-00250/${names[i]}" download>PDB</a> </td></tr>`); 
			}
